...
using MechanicService.Persistence.Repositories.ServiceRepositories;
...
builder.Services.AddScoped(typeof(IServiceDescriptionRepository), typeof(ServiceDescriptionRepository));
#endregion
